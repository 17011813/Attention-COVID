...
Original file is located at
    https://colab.research.google.com/drive/138c0eUM23QGpSytzA2yxO08iBwRM4pD0
"""
...
for i in range(10):
  ...
  model.add(layers.SimpleRNN(units=32, input_shape=[5,31]))     # LSTM에서는 5,31로 lstm_trainX로 넣어준다
...
plt.plot(Date.iloc[trainSize+predict_day:], predict, label = "RNN predictions")
...
plt.xticks(np.arange(0,240,60), fontsize=20)
plt.yticks(fontsize=20)
plt.title('COVID-19 Forecasting After 7 day',fontsize=20)
plt.xlabel('Date', fontsize=20)
plt.ylabel('No. of Confirmed Cases' ,fontsize=20)
plt.legend(prop={'size': 30})
